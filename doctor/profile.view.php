...
<form method="post" action="../../controller/doctor/profileHandler.php" enctype="multipart/form-data">
    ...
    <input type="number" name="consultation_fee" value="<?php echo $d['consultation_fee']; ?>" placeholder="Fee"><br>
    <input type="text" name="license_number" value="<?php echo $d['license_number']; ?>" placeholder="License Number"><br>
    <input type="number" name="experience_years" value="<?php echo $d['experience_years']; ?>" placeholder="Experience Years"><br>
